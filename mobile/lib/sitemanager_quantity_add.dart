...
class SitemanagerQuantityAddInventry extends StatefulWidget {
  const SitemanagerQuantityAddInventry({Key? key}) : super(key: key);

  @override
  _SitemanagerQuantityAddInventryState createState() =>
      _SitemanagerQuantityAddInventryState();
}

class _SitemanagerQuantityAddInventryState extends State<SitemanagerQuantityAddInventry> {
