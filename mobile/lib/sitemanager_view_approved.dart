...
class MyApp3 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: SitemanagerViewApproved(),
    );
  }
}

class SitemanagerViewApproved extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _SitemanagerViewApprovedState();
  }
}

class _SitemanagerViewApprovedState extends State<SitemanagerViewApproved> {
  Future<List<Order>> listDataJSON() async {
    final url = Uri.parse(
        "http://localhost:5000/purchase-order/sm-approved-orders/Maga-02");
