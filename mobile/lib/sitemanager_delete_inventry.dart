...
class SitemanagerDeleteInventry extends StatefulWidget {
  const SitemanagerDeleteInventry({Key? key}) : super(key: key);

  @override
  _SitemanagerDeleteInventryState createState() =>
      _SitemanagerDeleteInventryState();
}

class _SitemanagerDeleteInventryState extends State<SitemanagerDeleteInventry> {
