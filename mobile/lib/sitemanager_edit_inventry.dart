...
//   late Future<Inventry> _futureAlbum;

//   @override
//   void initState() {
//     super.initState();
//     _futureAlbum = fetchInventry();
//   }
//   // ··

//   Future<Inventry> fetchInventry() async {
//     final response = await http.get(Uri.parse(
//         'http://localhost:5000/inventory/get-one-inventory/6158a22cec5ae60c3d73eaa1'));
//     var x = json.decode(response.body);
//     if (response.statusCode == 200) {
//       // If the server did return a 200 OK response,
//       // then parse the JSON.
//       print(x);
//       return Inventry.fromJson(jsonDecode(response.body));
...
//   //Inventry inventry = Inventry.fromJson(json);
//   @override
...
//                               child: 
//                               FutureBuilder<Inventry> (future: _futureAlbum,
//                               builder: (context, snapshot){
//                                 if (snapshot.hasData) {
//                                   return Text(snapshot.data!.item_name);
