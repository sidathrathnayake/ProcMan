...
class SupplierForgotpassword extends StatefulWidget {
  const SupplierForgotpassword({Key? key}) : super(key: key);

  @override
  _SupplierForgotpasswordState createState() => _SupplierForgotpasswordState();
}

class _SupplierForgotpasswordState extends State<SupplierForgotpassword> {
  ...
  Future save() async {
    ...
    Navigator.push(
        context, new MaterialPageRoute(builder: (context) => SupplierSignIn()));
  }
