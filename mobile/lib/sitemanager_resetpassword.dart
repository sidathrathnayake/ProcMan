...
class SitemanagerResetpassword extends StatefulWidget {
  const SitemanagerResetpassword({Key? key}) : super(key: key);

  @override
  _SitemanagerResetpasswordState createState() =>
      _SitemanagerResetpasswordState();
}

User user = User("", "", "", "", "", "", "", "");
Color textfieldcolor = Colors.blue;

class _SitemanagerResetpasswordState extends State<SitemanagerResetpassword> {
