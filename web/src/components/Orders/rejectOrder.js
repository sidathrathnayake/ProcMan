                    ...
                    <div>
                        <div className="raisedOrderAddCont">
                            <form onSubmit={this.onSubmit}>
                                ...
                                <div class="form-group row" >
                                    <label for="form-control-note" class="col-4 form-label">Status</label>
                                    <div class="col-6">
                                        <input type="textarea" className="form-control" id="form-control-note" name="note" value={this.state.note} readOnly/>
                                    </div>
                                </div><br/>
                                <div class="form-group row" >
                                    <label for="form-control-status" class="col-4 form-label">Rejection Note</label>
                                    <div class="col-6">
                                        <input type="text" className="form-control" id="form-control-status" name="status" value={this.state.status}/>
                                    </div>
                                </div><br/>
                                <div class="form-group row" >
